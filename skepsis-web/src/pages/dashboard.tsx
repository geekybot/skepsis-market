...
const DashboardPage: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col px-4 sm:px-6 py-6 sm:py-8 max-w-7xl mx-auto pt-28 sm:pt-32 lg:pt-36">
        {/* Hero Section */}
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-600 to-violet-600 rounded-full mb-4 sm:mb-6">
            <User size={24} className="text-white sm:w-8 sm:h-8" />
          </div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">User Dashboard</h1>
          <p className="text-base sm:text-lg lg:text-xl text-white/70 mb-2 px-4">
            Your personalized trading hub is coming soon
          </p>
          {walletAddress && (
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-800/60 rounded-lg border border-white/10">
